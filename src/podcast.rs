...
/// Dedicated HTTP client for podcast work: episode audio downloads and
/// multi-chunk STT can each take minutes, so the shared 30s media client
/// (`crate::media::HTTP_CLIENT`) timeout is too aggressive here.
